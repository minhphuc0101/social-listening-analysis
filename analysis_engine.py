...
CAR_MODELS = {
    ...
    "Toyota Yaris Cross": [r"\byaris\s*cross\b"],
    "Toyota Yaris": [r"\byaris\b"],
    "Toyota Corolla Cross": [r"\bcorolla\s*cross\b", r"\bcorolla\b"],
    "Toyota Camry": [r"\bcamry\b"],
    "Toyota Fortuner": [r"\bfortuner\b"],
    "Toyota Altis": [r"\baltis\b", r"\bcorolla\s*altis\b"],
    "Toyota Wigo": [r"\bwigo\b"],
    "Toyota Raize": [r"\braize\b"],
    "Toyota Hilux": [r"\bhilux\b"],
    "Toyota Land Cruiser": [r"\bland\s*cruiser\b", r"\bprado\b", r"\blc\s*300\b", r"\blc\s*200\b"],
    "Toyota Alphard": [r"\balphard\b"],
