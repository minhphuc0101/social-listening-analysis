...
# =============================================================
    ...
    with col_neg1:
        with st.container(border=True):
            st.markdown("""
            <div style="font-size:1rem; font-weight:700; color:#1E293B; margin-bottom:8px;">
                Tỷ lệ tiêu cực theo Trang / Nhóm <span style="font-size:0.75rem; color:#94A3B8;">✕</span>
            </div>
            """, unsafe_allow_html=True)
    ...
    with col_neg2:
        with st.container(border=True):
            st.markdown("""
            <div style="font-size:1rem; font-weight:700; color:#1E293B; margin-bottom:8px;">
                Top Trang & Nhóm có nhiều phản ánh nhất <span style="font-size:0.75rem; color:#94A3B8;">✕</span>
            </div>
            """, unsafe_allow_html=True)
...
# =============================================================
    ...
    with col_pos1:
        with st.container(border=True):
            st.markdown("""
            <div style="font-size:1rem; font-weight:700; color:#1E293B; margin-bottom:8px;">
                Tỷ lệ tích cực theo Trang / Nhóm <span style="font-size:0.75rem; color:#94A3B8;">✕</span>
            </div>
            """, unsafe_allow_html=True)
    ...
    with col_pos2:
        with st.container(border=True):
            st.markdown("""
            <div style="font-size:1rem; font-weight:700; color:#1E293B; margin-bottom:8px;">
                Top Trang & Nhóm thảo luận tích cực nhất <span style="font-size:0.75rem; color:#94A3B8;">✕</span>
            </div>
            """, unsafe_allow_html=True)
