...
# =============================================================
    ...
    with st.container(border=True):
        ...
        with feed_c1:
            ...
            sel_model = st.selectbox("🚗 Lọc theo Mẫu xe:", options=all_models, index=def_m_idx, key=f"pp_feed_m_{active_pp_model}")
        ...
        with feed_c2:
            ...
            sel_chan = st.selectbox("📺 Lọc theo Kênh:", options=all_chans, index=def_c_idx, key=f"pp_feed_c_{active_pp_chan}")
